  ...
  get(type) {
    ...
    switch (type) {
      ...
      case 'media-url':
        r =
          void 0 !== MediaPageStoreData[this.id].data && void 0 !== MediaPageStoreData[this.id].data.url
            ...
            : 'N/A';
        break;
      case 'media-public-url':
        r =
          void 0 !== MediaPageStoreData[this.id].data && void 0 !== MediaPageStoreData[this.id].data.public_media_url
            ? MediaPageStoreData[this.id].data.public_media_url
            : null;
        break;
      ...
      case 'media-thumbnail-url':
        if (void 0 === MediaPageStoreData[this.id].data || void 0 === MediaPageStoreData[this.id].data.author_thumbnail ) {
           r = null;} else {
        const thumb = MediaPageStoreData[this.id].data.author_thumbnail;
        if (/^(?:https?:)?\/\//i.test(thumb)) {r = thumb;} else {
        r = this.mediacms_config.site.url.replace(/\/$/, '') + '/' + thumb.replace(/^\//, '');}}
        break;

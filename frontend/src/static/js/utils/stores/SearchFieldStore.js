...
class SearchFieldStore extends EventEmitter {
  constructor() {
    ...
    SearchFieldStoreData[
      ...
      celebritiesQuery: celebrities ? decodeURIComponent(celebrities).replace(/\+/g, ' ') : '',
      predictions: [],
    };
  ...
  get(type) {
    switch (type) {
      ...
      case 'search-celebrities':
        return SearchFieldStoreData[this.id].celebritiesQuery;
    }
    return null;
  }

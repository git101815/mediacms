...
import { compactTimeago } from '../../utils/helpers/compactTimeago';
      ...
      <div className="comment-inner">
        ...
        <div className="comment-content">
          <div className="comment-meta">
            ...
            <div className="comment-date">{compactTimeago(props.publish_date)}</div>
          </div>
          ...
          ? comments.map((c) => {
              return (
                <Comment
                  ...
                  author_thumb={c.author_thumbnail_url}

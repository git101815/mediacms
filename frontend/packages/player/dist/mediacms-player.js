	...
	function MediaPlayer(domPlayer, pluginOptions, pluginState, videoResolutions, videoPlaybackSpeeds, pluginStateUpdateCallback, onNextButtonClick, onPrevButtonClick) {
	  ...
	  const passOptions = constructVideojsOptions(pluginOptions, {
	    controlBar: {
          ...
          const hasVjs = !!(window && window.videojs);
          const getPlugin = hasVjs && typeof window.videojs.getPlugin === 'function'
          ? window.videojs.getPlugin.bind(window.videojs)
          : null;
          const adsPlugin = getPlugin ? getPlugin('ads') : null;
          passOptions.html5 = passOptions.html5 || {};
          passOptions.html5.vhs = passOptions.html5.vhs || {};
          passOptions.html5.vhs.withCredentials = true;
          passOptions.html5.hls = passOptions.html5.hls || {};
          passOptions.html5.hls.withCredentials = true;
	  this.player = videojs(domPlayer, passOptions);
          const imaAvailable = (typeof this.player?.ima === 'function');
	  this.player.mediaCmsVjsPlugin(domPlayer, pluginOptions, pluginState, pluginVideoResolutions, pluginVideoPlaybackSpeeds, pluginStateUpdateCallback, onNextButtonClick, onPrevButtonClick);
          if (adsPlugin && imaAvailable) {try{this.player.ima({adTagUrl: 'https://36707.badylenicesist.com/v2/a/prl/vst/261578', debug: false, showControlsForJSAds: true, vpaidMode: 'ENABLED'});}catch(e){console.warn("ima init failed", e)}}

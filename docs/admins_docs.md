...
- [23. Identity Providers setup](#23-identity-providers-setup)
- [24. Custom urls](#24-custom-urls)
...
- allows to add an Identity Provider through Django admin and configure mappings such as Group Mapping and Global Role Mapping

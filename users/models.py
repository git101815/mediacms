...
class User(AbstractUser):
    ...
    global_media_description = models.TextField("Global media description", blank=True, help_text="If set, this replaces per-video descriptions")
    ...
    advertiserUser = models.BooleanField("advertiser", default=False, db_index=True)

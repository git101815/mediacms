...
SMTP_EHLO_FQDN = "app.domain.tld"
SMTP_MSGID_DOMAIN = "domain.tld"
# who can add media
...
MP4DASH_COMMAND = "/home/mediacms.io/Bento4-SDK-1-6-0-637.x86_64-unknown-linux/bin/mp4dash"
MP4FRAGMENT_COMMAND = "/home/mediacms.io/Bento4-SDK-1-6-0-637.x86_64-unknown-linux/bin/mp4fragment"
...
AI_GENERATION_INTERNAL_SERVICE_USERNAME="ai_generation_service"
...
LEDGER_INTERNAL_ADDRESS_BATCH_MAX_SIZE = int(
    os.environ.get("LEDGER_INTERNAL_ADDRESS_BATCH_MAX_SIZE", "200")
)
LEDGER_INTERNAL_ADDRESS_STATS_MAX_SIZE = int(
    os.environ.get("LEDGER_INTERNAL_ADDRESS_STATS_MAX_SIZE", "200")
)
LEDGER_INTERNAL_SWEEPER_SERVICE_USERNAME = os.environ.get(
    "LEDGER_INTERNAL_SWEEPER_SERVICE_USERNAME",
    "",
).strip()
LEDGER_INTERNAL_SWEEPER_SERVICE_SHARED_SECRET = os.environ.get(
    "LEDGER_INTERNAL_SWEEPER_SERVICE_SHARED_SECRET",
    "",
).strip()
LEDGER_SWEEP_JOB_CLAIM_LEASE_SECONDS = int(
    os.environ.get("LEDGER_SWEEP_JOB_CLAIM_LEASE_SECONDS", "120")
)
LEDGER_SWEEP_JOB_CLAIM_MAX_BATCH = int(
    os.environ.get("LEDGER_SWEEP_JOB_CLAIM_MAX_BATCH", "50")
)
...
P2P_N8N_WEBHOOK_URL = os.environ.get("P2P_N8N_WEBHOOK_URL", "").strip()

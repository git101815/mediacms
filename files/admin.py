...
class MediaAdmin(admin.ModelAdmin):
    ...
    list_filter = ["state", "is_reviewed", "encoding_status", "featured", "category", "celebrities"]
    ordering = ("-add_date",)
    readonly_fields = ("user", "tags", "category", "celebrities", "channel")
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    list_display = ["title", "group", "user", "add_date", "media_count"]
    list_filter = []
    ordering = ("-add_date",)
    ...
    def get_list_filter(self, request):
        ...
        if getattr(settings, 'USE_RBAC', False):
            list_filter.insert(1, "is_rbac_category")
    ...
    def get_fieldsets(self, request, obj=None):
        basic_fieldset = [
            (
                ...
                {
                    'fields': ['uid', 'title', 'group',  'description', 'user', 'media_count', 'thumbnail', 'listings_thumbnail'],
                },
            ),
        ]
...
@admin.register(CelebrityGroup)
class CelebrityGroupAdmin(admin.ModelAdmin):
    search_fields = ("title",)
...
class CelebrityAdmin(admin.ModelAdmin):
    ...
    def get_fieldsets(self, request, obj=None):
        return [("Celebrity Information",{"fields": ["uid","title","group","description","is_global","user","media_count","thumbnail","listings_thumbnail"]})]

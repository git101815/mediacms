...
urlpatterns = [
    ...
    re_path(r"^partnership$", views.partnership, name="partnership"),
    ...
    re_path(r"^celebrities$", views.celebrities, name="celebrities"),
    ...
    re_path(
        r"^api/internal/ledger/deposit-watchlist$",
    ...
    re_path(r"^download/(?P<friendly_token>[\w\-_]+)/(?P<download_id>original|premium|\d+)/$", download_views.media_download_start, name="media_download_start"),
    ...
    re_path(r"^api/v1/celebrities$", views.CelebrityList.as_view()),
...
if hasattr(settings, "GENERATE_SITEMAP") and settings.GENERATE_SITEMAP:
    ...
    urlpatterns.append(path("video-sitemap.xml", video_sitemap, name="video_sitemap"))
